function [feasibilityScore] = feasibilityConstraint(NC,CA)
...
%         Design Connectivity Array CA         
    ...
    % THIRD CONSTRAINT: MEMBERS CANNOT PASS THROUGH NODES WITHOUT USING
    % THEM, UNLESS NO OTHER MEMBERS CONNECT AT IGNORED NODES
end
